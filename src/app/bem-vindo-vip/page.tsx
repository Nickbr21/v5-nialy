...
export default function BemVindoVipPage() {
    ...
    const timer = setInterval(() => {
      setCountdown(prev => {
        if (prev <= 1) {
          ...
          window.location.href = 'https://wa.me/5511999999999'; // Replace with actual WhatsApp group link
          return 0;
        }
        return prev - 1;
      });
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header Section */}
      <section className="py-16 bg-gradient-to-r from-[#0A1F44] to-[#1a3a5c] text-white">
              ...
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="p-6">
                  <div className="mb-4">
                    ...
                    <h4 className="text-lg font-semibold text-[#0A1F44] mb-3">{offer.title}</h4>
                    <div className="text-xl font-bold text-[#0A1F44] mb-4">
                      {offer.prices}
                    </div>
                  </div>
      ...
      <section className="py-20 bg-[#0A1F44]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-[#C1A36F]/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-[#C1A36F]/20">
            ...
            {/* Main CTA Button */}
            <a 
              href="https://wa.me/5511999999999" // Replace with actual WhatsApp group link
      ...
      <footer className="bg-[#0A1F44] text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-bold mb-6 text-lg">Benefícios VIP</h4>
              <div className="space-y-3 text-gray-300">
